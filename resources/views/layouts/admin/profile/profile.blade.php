...
<div class="card shadow mb-3" style="max-width: 540px;margin:auto">
    ...
    <div class="col-md-4 justify-content-center" style="margin:auto;display:flex;">
        <img src="/img/user/{{ Auth::user()->profile }}" style="width:90%" class="img-profile rounded-circle ml-5" alt="Users Profile">
    </div>
        <div class="col-md-8">
            <div class="card-body">
    ...
    <div class="card-footer mt-5 text-center" style="background-color: #8FC1D4">
        ...
        <div class="col">
    <a href="admin/dashboard" class="btn btn-light shadow-sm"><i class="fas fa-chevron-left"></i> Kembali</a></div>
    <div class="col">
